...
tweet = pd.read_csv(r"C:\Users\kaval\OneDrive\Desktop\360digit\datatypes\Disaster_tweets_NB.csv",encoding = "ISO-8859-1")
tweet = tweet.iloc[:,3:5]
# cleaning data 
import re
stop_words = []
# Load the custom built Stopwords
with open(r"C:\Users\kaval\OneDrive\Desktop\360digit\datatypes\stopwords_en.txt","r") as sw:
    stop_words = sw.read()
